...
class SudoApp(QWidget):
    ...
    def initUI(self):   
        ...
        self.theme_color, self.theme_bcolor = theme_manager.get_theme_colors(self.theme_color, self.theme_bcolor)
        ...
        self.passwordInput.setFixedWidth(int(faktor*280))

        self.aboutBtn = QPushButton(self)
        self.aboutBtn.setText("About EasyEggs")
        ...
        password_about = QHBoxLayout()

        password_about.addWidget(self.passwordInput)
        password_about.addStretch(0)
        password_about.addWidget(self.aboutBtn)
        ...
        layout.addLayout(password_about)
    ...
    def show_about_dialog(self):
        ...
        if language.startswith("de"):
            title = "Über X-Live EasyEggs"
            text = (f"X-Live EasyEggs<br><br>"
                    f"Autor: VerEnderT aka F. Maczollek<br>"
                    f"Webseite: <a href='https://github.com/verendert/x-live-easyeggs'>https://github.com/verendert/x-live-easyeggs</a><br>"
            ...
            title = "About X-Live EasyEggs"
            text = (f"X-Live EasyEggs<br><br>"
                    f"Author: VerEnderT aka F. Maczollek<br>"
                    f"Website: <a href='https://github.com/verendert/x-live-easyeggs'>https://github.com/verendert/x-live-easyeggs</a><br>"
                    f"Version: {version}<br><br>"
                    f"Copyright © 2023 - 2024 VerEnderT<br>"
    ...
    def get_version_info(self):
        try:
            result = subprocess.run(['apt', 'show', 'x-live-easyeggs'], capture_output=True, text=True)
